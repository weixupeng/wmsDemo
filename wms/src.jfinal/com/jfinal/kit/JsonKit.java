...
public class JsonKit {
	...
	//FIXME by lzy 是否处理成中国常见日期格式yyyy-MM-dd HH:mm:ss
	public static String customerDateFormart = null;
	private static String otherToJson(Object value, int depth) {
		//FIXME JSON日期格式处理 by lzy 要使用中国日期格式请先设置customerDateFormart=true
		if(customerDateFormart != null){
			if (value instanceof java.util.Date)
				return "\"" + escape(DateFormatUtils.format((java.util.Date)value,customerDateFormart)) + "\"";
